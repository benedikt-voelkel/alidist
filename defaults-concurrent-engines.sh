...
overrides:
  ...
  ROOT:
    tag: "v6-12-06-multi-engines"
    source: https://github.com/benedikt-voelkel/root
    requires:
      - AliEn-Runtime:(?!.*ppc64)
      - GSL
      - opengl:(?!osx)
  ...
  GEANT3:
    tag: "multi-engines"
    source: "https://github.com/benedikt-voelkel/geant3"
  GEANT4:
    tag: v10.3.3
    source: https://gitlab.cern.ch/geant4/geant4.git
  GEANT4_VMC:
    tag: "multi-engines"
    source: https://github.com/benedikt-voelkel/geant4_vmc
---
